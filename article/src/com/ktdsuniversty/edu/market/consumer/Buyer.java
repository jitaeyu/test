package com.ktdsuniversty.edu.market.consumer;

import com.ktdsuniversty.edu.market.seller.Seller;
...
public class Buyer {
	 ...
	 * @param productCount 구매자가 구매할 상품의 수
	 * 
	 * */
	public void buyFrom(Seller seller, int productCount) {
//		1. 구매자 : 혹시 두쫀쿠 productCount 만큼 상품재고있나요
...
//						있다!
		...
		//		8: 구매자: (내가 2.5kg 들 수 있나?)
				if(this.isEnoughWeight(weight*PRODUCT_WEIGHT)) {
					//						들수있다!
					//		9.구매자: 5개만 주시겠어요?
					//		10. 판매자: 두쫀쿠5 포장해서 구매자에게 준다.(판매자의 재고가 감소)
					int stock=seller.getStock();
					stock-=productCount;
					seller.setStock(stock);
					//		11. 구매자: 여기 5천원 드릴게요. (구매자의 돈이 감소, 판매자의 자산이 증가, 구매자의 무게와 구매갯수 증가,)
